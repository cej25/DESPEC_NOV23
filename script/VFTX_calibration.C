...
void VFTXCalibration(int module, int channel,bool plot =false) {
  ...
  std::ofstream f_int;
  std::ofstream f_cal;
  f_cal.open(Form("TBin2Ps/VFTX_%05d_Bin2Ps_ch%02d.dat",VFTX_SN,channel),std::ios::out);
  f_int.open(Form("TBin2Ps/INT/VFTX_%05d_INT_ch%02d.txt",VFTX_SN,channel),std::ios::out);
