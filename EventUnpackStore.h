...
public:
  ...
  //  Float_t fFRS_timestamp, fFRS_ts, fFRS_ts2;
    ...
    UInt_t       fFRS_scaler_delta[64];
        ...
        int fBB7_TWINPEAKS_Slow_Lead[BB7_SIDES][BB7_STRIPS_PER_SIDE][BB7_TAMEX_MAX_HITS];
        int fBB7_TWINPEAKS_Fast_Trail_N[BB7_SIDES][BB7_STRIPS_PER_SIDE];
        int fBB7_TWINPEAKS_Fast_Trail[BB7_SIDES][BB7_STRIPS_PER_SIDE][BB7_TAMEX_MAX_HITS];
        int fBB7_TWINPEAKS_Slow_Trail_N[BB7_SIDES][BB7_STRIPS_PER_SIDE];
        int fBB7_TWINPEAKS_Slow_Trail[BB7_SIDES][BB7_STRIPS_PER_SIDE][BB7_TAMEX_MAX_HITS];
