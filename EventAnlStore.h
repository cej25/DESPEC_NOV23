...
//       Int_t    pbPlas_TrailHits;
      ...
      Int_t pbPlas_FastChan[bPLASTIC_DETECTORS+1];
      Int_t pbPlas_SlowChan[bPLASTIC_DETECTORS+1];
      Int_t pbPlas_Fast_Lead_N[bPLASTIC_DETECTORS+1][bPLASTIC_CHAN_PER_DET];
      Int_t pbPlas_Slow_Lead_N[bPLASTIC_DETECTORS+1][bPLASTIC_CHAN_PER_DET];
      Double_t pbPlas_FastLeadT[bPLASTIC_DETECTORS+1][bPLASTIC_CHAN_PER_DET][bPLASTIC_TAMEX_HITS];
      Double_t pbPlas_SlowLeadT[bPLASTIC_DETECTORS+1][bPLASTIC_CHAN_PER_DET][bPLASTIC_TAMEX_HITS];
      Int_t pbPlas_FastLeadHits;
      Int_t pbPlas_SlowLeadHits;
      Int_t pbPlast_Fast_Trail_N[bPLASTIC_DETECTORS+1][bPLASTIC_CHAN_PER_DET];
      Int_t pbPlast_Slow_Trail_N[bPLASTIC_DETECTORS+1][bPLASTIC_CHAN_PER_DET];
      Double_t pbPlas_Fast_TrailT[bPLASTIC_DETECTORS+1][bPLASTIC_CHAN_PER_DET][bPLASTIC_TAMEX_HITS];
      Double_t pbPlas_Slow_TrailT[bPLASTIC_DETECTORS+1][bPLASTIC_CHAN_PER_DET][bPLASTIC_TAMEX_HITS];
      Double_t pbPlas_Fast_ToTCalib[bPLASTIC_DETECTORS+1][bPLASTIC_CHAN_PER_DET][bPLASTIC_TAMEX_HITS];
      Double_t pbPlas_Slow_ToTCalib[bPLASTIC_DETECTORS+1][bPLASTIC_CHAN_PER_DET][bPLASTIC_TAMEX_HITS];
